...
def main():
    ...
    binPath = dirname + "/Meshroom-2021.1.0/alicevision/bin"           ##  --> path of the binary files from Meshroom
    baseDir = "meshroom_out"           ##  --> name of the Folder containing the process (a new folder will be created)
    imgDir = "preprocessed"            ##  --> Folder containing the images 
